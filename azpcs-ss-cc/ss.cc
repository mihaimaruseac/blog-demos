...
int main() {
	...
	State s(31);
	std::vector<Coord> v{
		{-11,2},{-11,10},{-10,-4},{-10,2},{-9,11},{-8,-3},{-8,1},{-6,8},{-5,-8},{-5,2},{-5,7},{-4,-2},{-4,-1},{-4,6},{-4,7},{-4,9},{-3,7},{-2,2},{-2,5},{-1,4},{0,-2},{1,3},{1,4},{2,-5},{2,2},{2,6},{3,6},{4,3},{4,12},{5,-7},{1,1},{0,2},{-1,2},{-2,1},{-3,0},{1,2},{-3,-1},{-1,3},{2,3},{-2,4},{-3,4},{-4,5},{-5,5},{-6,6},{-7,7},{-7,8},{-6,9},{-2,0},{-5,9},{-1,-1},{-1,-2},{0,-3},{-3,3},{-4,2},{-5,3},{-6,3},{-7,2},{-6,1},{-5,0},{-7,6},{-5,-1},{-1,1},{-5,-2},{-5,-3},{-7,9},{-8,10},{-3,5},{-5,10},{-2,6},{-1,6},{-5,8},{0,5},{1,6},{1,7},{-1,-3},{-8,6},
	};
	for (const auto& [x,y]: v) {
		s.Place(x, y);
	}
